package com.example.holidayapiproject.Adapter;
...
import com.example.holidayapiproject.R;

import java.util.List;

public class HolidayAdapter extends RecyclerView.Adapter<HolidayAdapter.Holder> {
    private List<HolidaysItem> holidayList;
    private Context context;
    public HolidayAdapter(Context context, List<HolidaysItem> holidayList) {
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            ...
            tvPublic = (TextView) itemView.findViewById(R.id.tv_public);
        ...
        public void bind(final int position) {
            ...
            tvPublic.setText(holidayList.get(position).getPublic());
